...
if (!mapboxgl.supported()) {
    clusterMap.classList.add('text-center');
    clusterMap.innerHTML = "You don't see the map because your browser does not support Mapbox GL. Please use another browser.";
} else { 
    clusterMap.classList.add('cluster-map');
